...
namespace Sender.Test
{
    ...
    class OutputFileReader
    {
        ...
        {
            var streamReader = new StreamReader(@"D:\a\ReviewOfReviews\ReviewOfReviews\Sender.Test\bin\Debug\netcoreapp3.1\sample-review\LogFile.txt");
    ...
    public class SenderUnitTest
    {
        ...
        public void ThrowsExceptionWhenCsvFileNotFound()
        {
            ...
            var csvPath = @"C: \Users\Anji\source\repos\sample-review\review-report.csv";
